global.settings = {
    OWNER_NUMBERS: "2348144951766", // replace with your number
    OWNER_NAME: '𝙊𝙧𝙞𝙡𝙤𝙢𝙤', // desired name
    BOT_NAME: "𝙊𝙧𝙞𝙡𝙤𝙢𝙤", // desired name
    VERSION: 'V1.0.0',
    SESSION_ID: 'kord_ai-6740838377f0172775f11fcb', //put your session id between ''
